...
agenraci verify  --target github     <charter> --repo OWNER/REPO  # check a live repo enforces the charter (--org ORG sweeps a whole org, --limit N caps the listing, --format sarif uploads drift to code-scanning)
